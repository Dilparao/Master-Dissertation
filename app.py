...
def get_predictions(age, weight, ap_hi, ap_lo, gluc, bmi, req_model):
    mylist = [age, weight, ap_hi, ap_lo, gluc, bmi]
...
def my_form_post():
    ...
    target = get_predictions(age, weight, ap_hi, ap_lo, gluc,bmi, req_model)
